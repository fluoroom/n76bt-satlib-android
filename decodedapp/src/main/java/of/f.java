...
public final class f {
    ...
    private f(OutputStream outputStream, byte[] bArr) {
        this.f23447e = outputStream;
        this.f23443a = bArr;
        this.f23444b = bArr.length;
    }
    ...
    private void J() throws IOException {
        OutputStream outputStream = this.f23447e;
        if (outputStream == null) {
            throw new a();
        }
        outputStream.write(this.f23443a, 0, this.f23445c);
        this.f23445c = 0;
    }
    ...
    public void i0(d dVar, int i10, int i11) throws IOException {
        ...
        if (i12 - i13 >= i11) {
            dVar.h(this.f23443a, i10, i13, i11);
            this.f23445c += i11;
            this.f23446d += i11;
            return;
        }
        int i14 = i12 - i13;
        dVar.h(this.f23443a, i10, i13, i14);
        int i15 = i10 + i14;
        int i16 = i11 - i14;
        this.f23445c = this.f23444b;
        this.f23446d += i14;
        J();
        if (i16 <= this.f23444b) {
            dVar.h(this.f23443a, i15, 0, i16);
            this.f23445c = i16;
        } else {
            dVar.z(this.f23447e, i15, i16);
        }
        this.f23446d += i16;
    }
    ...
    public void k0(byte[] bArr, int i10, int i11) throws IOException {
        ...
        int i13 = this.f23445c;
        if (i12 - i13 >= i11) {
            System.arraycopy(bArr, i10, this.f23443a, i13, i11);
            this.f23445c += i11;
            this.f23446d += i11;
            return;
        }
        int i14 = i12 - i13;
        System.arraycopy(bArr, i10, this.f23443a, i13, i14);
        int i15 = i10 + i14;
        int i16 = i11 - i14;
        this.f23445c = this.f23444b;
        this.f23446d += i14;
        J();
        if (i16 <= this.f23444b) {
            System.arraycopy(bArr, i15, this.f23443a, 0, i16);
            this.f23445c = i16;
        } else {
            this.f23447e.write(bArr, i15, i16);
        }
        this.f23446d += i16;
    }
