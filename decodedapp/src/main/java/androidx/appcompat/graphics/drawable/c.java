...
public abstract class c extends Drawable implements Drawable.Callback {
    ...
    public void setHotspot(float f10, float f11) {
        e0.a.k(this.mDrawable, f10, f11);
    }

    @Override // android.graphics.drawable.Drawable
    public void setHotspotBounds(int i10, int i11, int i12, int i13) {
        e0.a.l(this.mDrawable, i10, i11, i12, i13);
    }
    ...
    public void setTint(int i10) {
        e0.a.n(this.mDrawable, i10);
    }

    @Override // android.graphics.drawable.Drawable
    public void setTintList(ColorStateList colorStateList) {
        e0.a.o(this.mDrawable, colorStateList);
    }

    @Override // android.graphics.drawable.Drawable
    public void setTintMode(PorterDuff.Mode mode) {
        e0.a.p(this.mDrawable, mode);
    }
