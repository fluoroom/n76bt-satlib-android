...
public class ScrollingTabContainerView extends HorizontalScrollView implements AdapterView.OnItemSelectedListener {
    ...
    private class TabAdapter extends BaseAdapter {
        ...
        public Object getItem(int i10) {
            ((TabView) ScrollingTabContainerView.this.mTabLayout.getChildAt(i10)).getTab();
            return null;
        }
    ...
    private class TabView extends LinearLayout {
        ...
        public TabView(Context context, a.b bVar, boolean z10) {
            int i10 = h.a.f14746e;
            super(context, null, i10);
            int[] iArr = {R.attr.background};
            this.BG_ATTRS = iArr;
            TintTypedArray tintTypedArrayObtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, null, iArr, i10, 0);
    ...
    private Spinner createSpinner() {
        AppCompatSpinner appCompatSpinner = new AppCompatSpinner(getContext(), null, h.a.f14752h);
    ...
    private LinearLayoutCompat createTabLayout() {
        LinearLayoutCompat linearLayoutCompat = new LinearLayoutCompat(getContext(), null, h.a.f14744d);
    ...
    public void addTab(a.b bVar, boolean z10) {
        TabView tabViewCreateTabView = createTabView(bVar, false);
    ...
    public void animateToVisibility(int i10) {
        ...
        if (i10 != 0) {
            ...
            viewPropertyAnimatorAlpha.setListener(this.mVisAnimListener.withFinalVisibility(viewPropertyAnimatorAlpha, i10));
        ...
        viewPropertyAnimatorAlpha2.setListener(this.mVisAnimListener.withFinalVisibility(viewPropertyAnimatorAlpha2, i10));
        viewPropertyAnimatorAlpha2.start();
    }

    TabView createTabView(a.b bVar, boolean z10) {
        TabView tabView = new TabView(getContext(), bVar, z10);
        if (z10) {
    ...
    public void onMeasure(int i10, int i11) {
        ...
        int iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(this.mContentHeight, WXVideoFileObject.FILE_SIZE_LIMIT);
    ...
    public void addTab(a.b bVar, int i10, boolean z10) {
        TabView tabViewCreateTabView = createTabView(bVar, false);
        this.mTabLayout.addView(tabViewCreateTabView, i10, new LinearLayoutCompat.LayoutParams(0, -1, 1.0f));
        Spinner spinner = this.mTabSpinner;
        if (spinner != null) {
            ((TabAdapter) spinner.getAdapter()).notifyDataSetChanged();
        }
