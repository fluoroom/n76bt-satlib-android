...
public class AppCompatLinearLayout extends LinearLayoutCompat {
    ...
    public AppCompatLinearLayout(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, R.attr.textViewStyle);
    }

    public AppCompatLinearLayout(Context context, AttributeSet attributeSet, int i10) {
