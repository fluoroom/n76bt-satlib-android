...
public class ButtonBarLayout extends LinearLayout {
    ...
    public ButtonBarLayout(Context context, AttributeSet attributeSet) {
        ...
        o0.l0(this, context, iArr, attributeSet, typedArrayObtainStyledAttributes, 0, 0);
        this.mAllowStacking = typedArrayObtainStyledAttributes.getBoolean(h.j.Q0, true);
    ...
    protected void onMeasure(int i10, int i11) {
        ...
        if (isStacked() || View.MeasureSpec.getMode(i10) != 1073741824) {
            ...
            iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(size, RtlSpacingHelper.UNDEFINED);
            z10 = true;
        }
