...
public class ThemeUtils {
    ...
    public static void checkAppCompatTheme(View view, Context context) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(h.j.A0);
        try {
            if (!typedArrayObtainStyledAttributes.hasValue(h.j.F0)) {
    ...
    static int getThemeAttrColor(Context context, int i10, float f10) {
        return d0.a.k(getThemeAttrColor(context, i10), Math.round(Color.alpha(r0) * f10));
    }
}
