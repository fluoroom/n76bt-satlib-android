...
class SuggestionsAdapter extends androidx.cursoradapter.widget.c implements View.OnClickListener {
    ...
    private static final class ChildViewCache {
        ...
        public ChildViewCache(View view) {
            ...
            this.mIconRefine = (ImageView) view.findViewById(h.f.f14858s);
        }
    }
    ...
    private CharSequence formatUrl(CharSequence charSequence) {
        if (this.mUrlColor == null) {
            ...
            this.mProviderContext.getTheme().resolveAttribute(h.a.D0, typedValue, true);
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    Log.e(LOG_TAG, "Error closing icon stream for " + uri, e102);
                }
            }
    ...
    private Drawable getDrawableFromResourceValue(String str) {
        ...
        try {
            ...
            String str2 = "android.resource://" + this.mProviderContext.getPackageName() + "/" + i10;
            Drawable drawableCheckIconCache = checkIconCache(str2);
            if (drawableCheckIconCache != null) {
                return drawableCheckIconCache;
            }
            Drawable drawableD = b0.b.d(this.mProviderContext, i10);
            storeInIconCache(str2, drawableD);
            return drawableD;
        } catch (Resources.NotFoundException unused) {
    ...
    public View getDropDownView(int i10, View view, ViewGroup viewGroup) {
        try {
            ...
            if (viewNewDropDownView != null) {
                ((ChildViewCache) viewNewDropDownView.getTag()).mText1.setText(e10.toString());
            }
    ...
    Cursor getSearchManagerSuggestions(SearchableInfo searchableInfo, String str, int i10) {
    ...
    public View getView(int i10, View view, ViewGroup viewGroup) {
        try {
            ...
            if (viewNewView != null) {
                ((ChildViewCache) viewNewView.getTag()).mText1.setText(e10.toString());
            }
            return viewNewView;
        }
    }
    ...
    public View newView(Context context, Cursor cursor, ViewGroup viewGroup) {
        ...
        ((ImageView) viewNewView.findViewById(h.f.f14858s)).setImageResource(this.mCommitIconResId);
        return viewNewView;
    }
