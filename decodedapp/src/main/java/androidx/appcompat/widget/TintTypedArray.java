...
public class TintTypedArray {
    ...
    public ColorStateList getColorStateList(int i10) {
        ...
        return (!this.mWrapped.hasValue(i10) || (resourceId = this.mWrapped.getResourceId(i10, 0)) == 0 || (colorStateListA = i.a.a(this.mContext, resourceId)) == null) ? this.mWrapped.getColorStateList(i10) : colorStateListA;
    }
    ...
    public Drawable getDrawable(int i10) {
        int resourceId;
        return (!this.mWrapped.hasValue(i10) || (resourceId = this.mWrapped.getResourceId(i10, 0)) == 0) ? this.mWrapped.getDrawable(i10) : i.a.b(this.mContext, resourceId);
    }
    ...
    public Typeface getFont(int i10, int i11, k.e eVar) {
        ...
        return c0.k.h(this.mContext, resourceId, this.mTypedValue, i11, eVar);
    }
