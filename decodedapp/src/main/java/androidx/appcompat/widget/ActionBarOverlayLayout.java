...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, y, z {
    ...
    static final int[] ATTRS = {h.a.f14740b, R.attr.windowContentOverlay};
    private static final i1 NON_EMPTY_SYSTEM_WINDOW_INSETS = new i1.b().d(d0.b.b(0, 1, 0, 1)).a();
    ...
    */
    ...
    private boolean decorFitsSystemWindows() {
        o0.i(this.mNoSystemUiLayoutFlagView, NON_EMPTY_SYSTEM_WINDOW_INSETS, this.mTmpRect);
    ...
    private boolean shouldHideActionBarOnFling(float f10) {
        this.mFlingEstimator.fling(0, 0, 0, (int) f10, 0, 0, RtlSpacingHelper.UNDEFINED, ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED);
    ...
    public WindowInsets onApplyWindowInsets(WindowInsets windowInsets) {
        pullChildren();
        i1 i1VarX = i1.x(windowInsets, this);
        boolean zApplyInsets = applyInsets(this.mActionBarTop, new Rect(i1VarX.j(), i1VarX.l(), i1VarX.k(), i1VarX.i()), true, true, false, true);
        o0.i(this, i1VarX, this.mBaseContentInsets);
        Rect rect = this.mBaseContentInsets;
        i1 i1VarM = i1VarX.m(rect.left, rect.top, rect.right, rect.bottom);
        this.mBaseInnerInsets = i1VarM;
        boolean z10 = true;
        if (!this.mLastBaseInnerInsets.equals(i1VarM)) {
    ...
    protected void onMeasure(int i10, int i11) {
        ...
        if (this.mOverlayMode || z10 || !decorFitsSystemWindows()) {
            this.mInnerInsets = new i1.b(this.mInnerInsets).d(d0.b.b(this.mInnerInsets.j(), this.mInnerInsets.l() + measuredHeight, this.mInnerInsets.k(), this.mInnerInsets.i())).a();
        } else {
            Rect rect = this.mContentInsets;
            rect.top += measuredHeight;
            rect.bottom = rect.bottom;
            this.mInnerInsets = this.mInnerInsets.m(0, measuredHeight, 0, 0);
        }
        applyInsets(this.mContent, this.mContentInsets, true, true, true, true);
        if (!this.mLastInnerInsets.equals(this.mInnerInsets)) {
            i1 i1Var = this.mInnerInsets;
            this.mLastInnerInsets = i1Var;
            o0.j(this.mContent, i1Var);
        }
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(h.f.f14841b);
            this.mActionBarTop = (ActionBarContainer) findViewById(h.f.f14842c);
            this.mDecorToolbar = getDecorToolbar(findViewById(h.f.f14840a));
        }
    }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attributeSet) {
        ...
        i1 i1Var = i1.f20802b;
        this.mBaseInnerInsets = i1Var;
        this.mLastBaseInnerInsets = i1Var;
        this.mInnerInsets = i1Var;
        this.mLastInnerInsets = i1Var;
