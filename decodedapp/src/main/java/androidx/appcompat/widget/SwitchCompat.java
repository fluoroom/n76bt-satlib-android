...
public class SwitchCompat extends CompoundButton implements EmojiCompatConfigurationView {
    ...
    static class EmojiCompatInitCallback extends e.f {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<SwitchCompat> {
        ...
        public void mapProperties(PropertyMapper propertyMapper) {
            ...
            this.mShowTextId = propertyMapper.mapBoolean("showText", h.a.f14783w0);
            this.mSplitTrackId = propertyMapper.mapBoolean("splitTrack", h.a.f14787y0);
            this.mSwitchMinWidthId = propertyMapper.mapInt("switchMinWidth", h.a.A0);
            this.mSwitchPaddingId = propertyMapper.mapInt("switchPadding", h.a.B0);
            this.mThumbTextPaddingId = propertyMapper.mapInt("thumbTextPadding", h.a.F0);
            this.mThumbTintId = propertyMapper.mapObject("thumbTint", h.a.G0);
            this.mThumbTintModeId = propertyMapper.mapObject("thumbTintMode", h.a.H0);
            this.mTrackId = propertyMapper.mapObject("track", h.a.R0);
            this.mTrackTintId = propertyMapper.mapObject("trackTint", h.a.S0);
            this.mTrackTintModeId = propertyMapper.mapObject("trackTintMode", h.a.T0);
        ...
        if (drawable != null) {
            if (this.mHasThumbTint || this.mHasThumbTintMode) {
                ...
                if (this.mHasThumbTint) {
                    e0.a.o(drawableMutate, this.mThumbTintList);
                }
                if (this.mHasThumbTintMode) {
                    e0.a.p(this.mThumbDrawable, this.mThumbTintMode);
                }
        ...
        if (drawable != null) {
            if (this.mHasTrackTint || this.mHasTrackTintMode) {
                ...
                if (this.mHasTrackTint) {
                    e0.a.o(drawableMutate, this.mTrackTintList);
                }
                if (this.mHasTrackTintMode) {
                    e0.a.p(this.mTrackDrawable, this.mTrackTintMode);
                }
    ...
    private void setOffStateDescriptionOnRAndAbove() {
        if (Build.VERSION.SDK_INT >= 30) {
            ...
            if (string == null) {
                string = getResources().getString(h.h.f14891d);
            }
            o0.C0(this, string);
        }
    }
    ...
    private void setOnStateDescriptionOnRAndAbove() {
        if (Build.VERSION.SDK_INT >= 30) {
            ...
            if (string == null) {
                string = getResources().getString(h.h.f14892e);
            }
            o0.C0(this, string);
        }
    }
    ...
    private void setupEmojiCompatLoadCallback() {
        if (this.mEmojiCompatInitCallback == null && this.mAppCompatEmojiTextHelper.isEnabled() && androidx.emoji2.text.e.i()) {
            ...
            if (iE == 3 || iE == 0) {
                ...
                eVarC.t(emojiCompatInitCallback);
            }
        }
    }
    ...
    public void draw(Canvas canvas) {
        ...
        if (drawable3 != null) {
            ...
            if (background != null) {
                e0.a.l(background, i24, i13, i25, i15);
            }
        }
        super.draw(canvas);
    }
    ...
    */
    ...
    public void setSwitchTextAppearance(Context context, int i10) {
        ...
        ColorStateList colorStateList = tintTypedArrayObtainStyledAttributes.getColorStateList(h.j.f14953g3);
        if (colorStateList != null) {
            this.mTextColors = colorStateList;
        } else {
            this.mTextColors = getTextColors();
        }
        int dimensionPixelSize = tintTypedArrayObtainStyledAttributes.getDimensionPixelSize(h.j.f14935d3, 0);
        ...
        setSwitchTypefaceByIndex(tintTypedArrayObtainStyledAttributes.getInt(h.j.f14941e3, -1), tintTypedArrayObtainStyledAttributes.getInt(h.j.f14947f3, -1));
        if (tintTypedArrayObtainStyledAttributes.getBoolean(h.j.f15010r3, false)) {
            this.mSwitchTransformationMethod = new k.a(getContext());
        } else {
    ...
    public SwitchCompat(Context context, AttributeSet attributeSet, int i10) {
        ...
        Drawable drawable = tintTypedArrayObtainStyledAttributes.getDrawable(h.j.Q2);
        this.mThumbDrawable = drawable;
        if (drawable != null) {
            drawable.setCallback(this);
        }
        Drawable drawable2 = tintTypedArrayObtainStyledAttributes.getDrawable(h.j.Z2);
        this.mTrackDrawable = drawable2;
        if (drawable2 != null) {
            drawable2.setCallback(this);
        }
        setTextOnInternal(tintTypedArrayObtainStyledAttributes.getText(h.j.O2));
        setTextOffInternal(tintTypedArrayObtainStyledAttributes.getText(h.j.P2));
        this.mShowText = tintTypedArrayObtainStyledAttributes.getBoolean(h.j.R2, true);
        this.mThumbTextPadding = tintTypedArrayObtainStyledAttributes.getDimensionPixelSize(h.j.W2, 0);
        this.mSwitchMinWidth = tintTypedArrayObtainStyledAttributes.getDimensionPixelSize(h.j.T2, 0);
        this.mSwitchPadding = tintTypedArrayObtainStyledAttributes.getDimensionPixelSize(h.j.U2, 0);
        this.mSplitTrack = tintTypedArrayObtainStyledAttributes.getBoolean(h.j.S2, false);
        ColorStateList colorStateList = tintTypedArrayObtainStyledAttributes.getColorStateList(h.j.X2);
        if (colorStateList != null) {
            this.mThumbTintList = colorStateList;
            this.mHasThumbTint = true;
        }
        PorterDuff.Mode tintMode = DrawableUtils.parseTintMode(tintTypedArrayObtainStyledAttributes.getInt(h.j.Y2, -1), null);
        ...
        ColorStateList colorStateList2 = tintTypedArrayObtainStyledAttributes.getColorStateList(h.j.f14917a3);
        if (colorStateList2 != null) {
            this.mTrackTintList = colorStateList2;
            this.mHasTrackTint = true;
        }
        PorterDuff.Mode tintMode2 = DrawableUtils.parseTintMode(tintTypedArrayObtainStyledAttributes.getInt(h.j.f14923b3, -1), null);
        ...
        int resourceId = tintTypedArrayObtainStyledAttributes.getResourceId(h.j.V2, 0);
        if (resourceId != 0) {
