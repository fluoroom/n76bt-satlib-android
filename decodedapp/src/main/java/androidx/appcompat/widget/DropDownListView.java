...
class DropDownListView extends ListView {
    ...
    private y0 mClickAnimation;
    private boolean mDrawsInPressedState;
    private boolean mHijackFocus;
    private boolean mListSelectionHidden;
    private int mMotionPosition;
    ResolveHoverRunnable mResolveHoverRunnable;
    private androidx.core.widget.f mScrollHelper;
    ...
    private static class GateKeeperDrawable extends androidx.appcompat.graphics.drawable.c {
    ...
    DropDownListView(Context context, boolean z10) {
        super(context, null, h.a.f14739a0);
    ...
    private void positionSelectorLikeFocusCompat(int i10, View view) {
        ...
        if (z10) {
            ...
            e0.a.k(selector, fExactCenterX, fExactCenterY);
        }
    }
    ...
    public int measureHeightOfChildrenCompat(int i10, int i11, int i12, int i13, int i14) {
        ...
        while (i15 < count) {
            ...
            view.measure(i10, i18 > 0 ? View.MeasureSpec.makeMeasureSpec(i18, WXVideoFileObject.FILE_SIZE_LIMIT) : View.MeasureSpec.makeMeasureSpec(0, 0));
            view.forceLayout();
            if (i15 > 0) {
