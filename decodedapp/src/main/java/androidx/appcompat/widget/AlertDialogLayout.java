    ...
    private boolean tryOnMeasure(int i10, int i11) {
        ...
        for (int i12 = 0; i12 < childCount; i12++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id2 == h.f.V) {
                    view = childAt;
                } else if (id2 == h.f.f14851l) {
                    view2 = childAt;
                } else {
                    if ((id2 != h.f.f14853n && id2 != h.f.f14855p) || view3 != null) {
                        return false;
                    }
                    view3 = childAt;
                }
        ...
        if (view2 != null) {
            int i14 = paddingTop - iResolveMinimumHeight;
            int iMin = Math.min(i13, measuredHeight);
            if (iMin > 0) {
                i13 -= iMin;
                iResolveMinimumHeight += iMin;
            }
            view2.measure(i10, View.MeasureSpec.makeMeasureSpec(iResolveMinimumHeight, WXVideoFileObject.FILE_SIZE_LIMIT));
