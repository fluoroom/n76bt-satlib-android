...
class AppCompatProgressBarHelper {
    ...
    private Drawable tileifyIndeterminate(Drawable drawable) {
        ...
        for (int i10 = 0; i10 < numberOfFrames; i10++) {
            Drawable drawableTileify = tileify(animationDrawable.getFrame(i10), true);
            drawableTileify.setLevel(10000);
            animationDrawable2.addFrame(drawableTileify, animationDrawable.getDuration(i10));
        }
    ...
    void loadFromAttributes(AttributeSet attributeSet, int i10) {
        TintTypedArray tintTypedArrayObtainStyledAttributes = TintTypedArray.obtainStyledAttributes(this.mView.getContext(), attributeSet, TINT_ATTRS, i10, 0);
    ...
    Drawable tileify(Drawable drawable, boolean z10) {
        if (drawable instanceof e0.c) {
            e0.c cVar = (e0.c) drawable;
            Drawable drawableB = cVar.b();
            if (drawableB != null) {
                cVar.a(tileify(drawableB, z10));
                return drawable;
            }
        } else {
