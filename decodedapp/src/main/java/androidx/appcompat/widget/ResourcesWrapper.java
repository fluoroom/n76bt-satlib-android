...
class ResourcesWrapper extends Resources {
    ...
    final Drawable getDrawableCanonical(int i10) throws Resources.NotFoundException {
        return super.getDrawable(i10);
    }

    @Override // android.content.res.Resources
    public Drawable getDrawableForDensity(int i10, int i11) throws Resources.NotFoundException {
        return c0.k.f(this.mResources, i10, i11, null);
    }
    ...
    public Drawable getDrawable(int i10, Resources.Theme theme) throws Resources.NotFoundException {
        return c0.k.e(this.mResources, i10, theme);
    }

    @Override // android.content.res.Resources
    public Drawable getDrawableForDensity(int i10, int i11, Resources.Theme theme) {
        return c0.k.f(this.mResources, i10, i11, theme);
    }
