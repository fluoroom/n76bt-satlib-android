...
public class SearchView extends LinearLayoutCompat implements androidx.appcompat.view.c {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<SearchView> {
        ...
        public void mapProperties(PropertyMapper propertyMapper) {
            ...
            this.mIconifiedByDefaultId = propertyMapper.mapBoolean("iconifiedByDefault", h.a.f14745d0);
            this.mQueryHintId = propertyMapper.mapObject("queryHint", h.a.f14771q0);
    ...
    static class SavedState extends q0.a {
    ...
    private int getPreferredHeight() {
        return getContext().getResources().getDimensionPixelSize(h.d.f14805g);
    }

    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(h.d.f14806h);
    }
    ...
    void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int dimensionPixelSize = this.mIconifiedByDefault ? resources.getDimensionPixelSize(h.d.f14803e) + resources.getDimensionPixelSize(h.d.f14804f) : 0;
    ...
    public SearchView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, h.a.f14777t0);
    }
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i10) {
        ...
        LayoutInflater.from(context).inflate(tintTypedArrayObtainStyledAttributes.getResourceId(h.j.f15049z2, h.g.f14885t), (ViewGroup) this, true);
        SearchAutoComplete searchAutoComplete = (SearchAutoComplete) findViewById(h.f.J);
        this.mSearchSrcTextView = searchAutoComplete;
        searchAutoComplete.setSearchView(this);
        this.mSearchEditFrame = findViewById(h.f.F);
        ...
        o0.q0(viewFindViewById, tintTypedArrayObtainStyledAttributes.getDrawable(h.j.A2));
        o0.q0(viewFindViewById2, tintTypedArrayObtainStyledAttributes.getDrawable(h.j.E2));
        int i11 = h.j.D2;
        imageView.setImageDrawable(tintTypedArrayObtainStyledAttributes.getDrawable(i11));
        imageView2.setImageDrawable(tintTypedArrayObtainStyledAttributes.getDrawable(h.j.f15039x2));
        imageView3.setImageDrawable(tintTypedArrayObtainStyledAttributes.getDrawable(h.j.f15024u2));
        imageView4.setImageDrawable(tintTypedArrayObtainStyledAttributes.getDrawable(h.j.G2));
        imageView5.setImageDrawable(tintTypedArrayObtainStyledAttributes.getDrawable(i11));
        this.mSearchHintIcon = tintTypedArrayObtainStyledAttributes.getDrawable(h.j.C2);
        TooltipCompat.setTooltipText(imageView, getResources().getString(h.h.f14903p));
        this.mSuggestionRowLayout = tintTypedArrayObtainStyledAttributes.getResourceId(h.j.F2, h.g.f14884s);
        this.mSuggestionCommitIconResId = tintTypedArrayObtainStyledAttributes.getResourceId(h.j.f15029v2, 0);
        ...
        setIconifiedByDefault(tintTypedArrayObtainStyledAttributes.getBoolean(h.j.f15044y2, true));
        int dimensionPixelSize = tintTypedArrayObtainStyledAttributes.getDimensionPixelSize(h.j.f15009r2, -1);
        if (dimensionPixelSize != -1) {
            setMaxWidth(dimensionPixelSize);
        }
        this.mDefaultQueryHint = tintTypedArrayObtainStyledAttributes.getText(h.j.f15034w2);
        this.mQueryHint = tintTypedArrayObtainStyledAttributes.getText(h.j.B2);
        int i12 = tintTypedArrayObtainStyledAttributes.getInt(h.j.f15019t2, -1);
        if (i12 != -1) {
            setImeOptions(i12);
        }
        int i13 = tintTypedArrayObtainStyledAttributes.getInt(h.j.f15014s2, -1);
        if (i13 != -1) {
            setInputType(i13);
        }
        setFocusable(tintTypedArrayObtainStyledAttributes.getBoolean(h.j.f15004q2, true));
