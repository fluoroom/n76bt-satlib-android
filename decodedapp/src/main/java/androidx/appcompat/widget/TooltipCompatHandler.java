...
class TooltipCompatHandler implements View.OnLongClickListener, View.OnHoverListener, View.OnAttachStateChangeListener {
    ...
    private final Runnable mShowRunnable = new Runnable() { // from class: androidx.appcompat.widget.k
        @Override // java.lang.Runnable
        public final void run() {
            this.f1326a.show(false);
        }
    };
    private final Runnable mHideRunnable = new Runnable() { // from class: androidx.appcompat.widget.l
        @Override // java.lang.Runnable
        public final void run() {
            this.f1327a.hide();
        }
    ...
    private TooltipCompatHandler(View view, CharSequence charSequence) {
        ...
        this.mHoverSlop = r0.g(ViewConfiguration.get(view.getContext()));
