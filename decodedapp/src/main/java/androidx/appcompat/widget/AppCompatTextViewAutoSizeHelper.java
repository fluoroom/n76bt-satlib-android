...
class AppCompatTextViewAutoSizeHelper {
    ...
    private static final class Api23Impl {
        ...
        static StaticLayout createStaticLayoutForMeasuring(CharSequence charSequence, Layout.Alignment alignment, int i10, int i11, TextView textView, TextPaint textPaint, Impl impl) {
    ...
    static <T> T invokeAndReturnWithDefault(Object obj, String str, T t10) {
        try {
    ...
    StaticLayout createLayout(CharSequence charSequence, Layout.Alignment alignment, int i10, int i11) {
    ...
    void loadFromAttributes(AttributeSet attributeSet, int i10) {
        ...
        int[] iArr = h.j.f14962i0;
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, iArr, i10, 0);
        TextView textView = this.mTextView;
        o0.l0(textView, textView.getContext(), iArr, attributeSet, typedArrayObtainStyledAttributes, i10, 0);
        int i11 = h.j.f14987n0;
        if (typedArrayObtainStyledAttributes.hasValue(i11)) {
            this.mAutoSizeTextType = typedArrayObtainStyledAttributes.getInt(i11, 0);
        }
        int i12 = h.j.f14982m0;
        float dimension = typedArrayObtainStyledAttributes.hasValue(i12) ? typedArrayObtainStyledAttributes.getDimension(i12, UNSET_AUTO_SIZE_UNIFORM_CONFIGURATION_VALUE) : UNSET_AUTO_SIZE_UNIFORM_CONFIGURATION_VALUE;
        int i13 = h.j.f14972k0;
        float dimension2 = typedArrayObtainStyledAttributes.hasValue(i13) ? typedArrayObtainStyledAttributes.getDimension(i13, UNSET_AUTO_SIZE_UNIFORM_CONFIGURATION_VALUE) : UNSET_AUTO_SIZE_UNIFORM_CONFIGURATION_VALUE;
        int i14 = h.j.f14967j0;
        float dimension3 = typedArrayObtainStyledAttributes.hasValue(i14) ? typedArrayObtainStyledAttributes.getDimension(i14, UNSET_AUTO_SIZE_UNIFORM_CONFIGURATION_VALUE) : UNSET_AUTO_SIZE_UNIFORM_CONFIGURATION_VALUE;
        int i15 = h.j.f14977l0;
    ...
    void setTextSizeInternal(int i10, float f10) {
        Context context = this.mContext;
