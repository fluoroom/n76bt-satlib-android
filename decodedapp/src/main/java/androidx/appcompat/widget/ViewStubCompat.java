...
public final class ViewStubCompat extends View {
    ...
    public ViewStubCompat(Context context, AttributeSet attributeSet, int i10) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, h.j.f14942e4, i10, 0);
        this.mInflatedId = typedArrayObtainStyledAttributes.getResourceId(h.j.f14960h4, -1);
        this.mLayoutResource = typedArrayObtainStyledAttributes.getResourceId(h.j.f14954g4, 0);
        setId(typedArrayObtainStyledAttributes.getResourceId(h.j.f14948f4, -1));
