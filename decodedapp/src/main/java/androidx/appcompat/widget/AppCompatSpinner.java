...
public class AppCompatSpinner extends Spinner {
    ...
    private static final class Api23Impl {
        ...
        static void setDropDownViewTheme(android.widget.ThemedSpinnerAdapter themedSpinnerAdapter, Resources.Theme theme) {
            if (l0.b.a(themedSpinnerAdapter.getDropDownViewTheme(), theme)) {
                return;
            }
    ...
    class DialogPopup implements SpinnerPopup, DialogInterface.OnClickListener {
        ...
        androidx.appcompat.app.c mPopup;
        ...
        public void dismiss() {
            androidx.appcompat.app.c cVar = this.mPopup;
            if (cVar != null) {
                cVar.dismiss();
                this.mPopup = null;
            }
        ...
        public void show(int i10, int i11) {
            ...
            androidx.appcompat.app.c cVarA = aVar.w(this.mListAdapter, AppCompatSpinner.this.getSelectedItemPosition(), this).a();
            this.mPopup = cVarA;
            ListView listViewM = cVarA.m();
    ...
    private static class DropDownAdapter implements ListAdapter, SpinnerAdapter {
        ...
        public DropDownAdapter(SpinnerAdapter spinnerAdapter, Resources.Theme theme) {
            ...
            if (theme != null) {
                if (Build.VERSION.SDK_INT >= 23 && b.a(spinnerAdapter)) {
                    Api23Impl.setDropDownViewTheme(c.a(spinnerAdapter), theme);
    ...
    class DropdownPopup extends ListPopupWindow implements SpinnerPopup {
        ...
        public DropdownPopup(Context context, AttributeSet attributeSet, int i10) {
            ...
            setOnItemClickListener(new AdapterView.OnItemClickListener() { // from class: androidx.appcompat.widget.AppCompatSpinner.DropdownPopup.1
                ...
                public void onItemClick(AdapterView<?> adapterView, View view, int i102, long j10) {
                    AppCompatSpinner.this.setSelection(i102);
                    if (AppCompatSpinner.this.getOnItemClickListener() != null) {
                        DropdownPopup dropdownPopup = DropdownPopup.this;
                        AppCompatSpinner.this.performItemClick(view, i102, dropdownPopup.mAdapter.getItemId(i102));
                    }
                    DropdownPopup.this.dismiss();
                }
            });
        ...
        void computeContentWidth() {
            ...
            if (i11 == -2) {
                ...
                if (iCompatMeasureContentWidth > i13) {
                    iCompatMeasureContentWidth = i13;
                }
    ...
    public AppCompatSpinner(Context context, int i10) {
        this(context, null, h.a.f14785x0, i10);
    }
    ...
    public AppCompatSpinner(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, h.a.f14785x0);
    }
