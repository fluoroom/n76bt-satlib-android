...
public class ActionBarContainer extends android.widget.FrameLayout {
    ...
    public void onFinishInflate() {
        ...
        this.mActionBarView = findViewById(h.f.f14840a);
        this.mContextView = findViewById(h.f.f14845f);
    }
    ...
    public void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (this.mIsSplit) {
            ...
            this.mIsStacked = z13;
            if (!z13 || (drawable = this.mStackedBackground) == null) {
                z11 = z12;
            } else {
    ...
    public void onMeasure(int i10, int i11) {
        ...
        if (this.mActionBarView == null && View.MeasureSpec.getMode(i11) == Integer.MIN_VALUE && (i12 = this.mHeight) >= 0) {
            i11 = View.MeasureSpec.makeMeasureSpec(Math.min(i12, View.MeasureSpec.getSize(i11)), RtlSpacingHelper.UNDEFINED);
        }
        ...
        setMeasuredDimension(getMeasuredWidth(), Math.min((!isCollapsed(this.mActionBarView) ? getMeasuredHeightWithMargins(this.mActionBarView) : !isCollapsed(this.mContextView) ? getMeasuredHeightWithMargins(this.mContextView) : 0) + getMeasuredHeightWithMargins(this.mTabContainer), mode == Integer.MIN_VALUE ? View.MeasureSpec.getSize(i11) : ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED));
    }
    ...
    public ActionBarContainer(Context context, AttributeSet attributeSet) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, h.j.f14913a);
        this.mBackground = typedArrayObtainStyledAttributes.getDrawable(h.j.f14919b);
        this.mStackedBackground = typedArrayObtainStyledAttributes.getDrawable(h.j.f14931d);
        this.mHeight = typedArrayObtainStyledAttributes.getDimensionPixelSize(h.j.f14966j, -1);
        boolean z10 = true;
        if (getId() == h.f.N) {
            this.mIsSplit = true;
            this.mSplitBackground = typedArrayObtainStyledAttributes.getDrawable(h.j.f14925c);
        }
