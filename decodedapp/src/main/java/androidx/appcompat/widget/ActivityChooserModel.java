...
class ActivityChooserModel extends DataSetObservable {
    ...
    private static final class DefaultSorter implements ActivitySorter {
        ...
        public void sort(Intent intent, List<ActivityResolveInfo> list, List<HistoricalRecord> list2) {
            ...
            float f10 = ActivityChooserModel.DEFAULT_HISTORICAL_RECORD_WEIGHT;
    ...
    public static final class HistoricalRecord {
        ...
        public int hashCode() {
            ...
            long j10 = this.time;
            return ((((iHashCode + 31) * 31) + ((int) (j10 ^ (j10 >>> 32)))) * 31) + Float.floatToIntBits(this.weight);
        }
        ...
        try {
            ...
            try {
                try {
                    ...
                    xmlPullParserNewPullParser.setInput(fileInputStreamOpenFileInput, Utf8Charset.NAME);
    ...
    public void setDefaultActivity(int i10) {
        synchronized (this.mInstanceLock) {
            try {
                ...
                float f10 = activityResolveInfo2 != null ? (activityResolveInfo2.weight - activityResolveInfo.weight) + 5.0f : DEFAULT_HISTORICAL_RECORD_WEIGHT;
                ActivityInfo activityInfo = activityResolveInfo.resolveInfo.activityInfo;
