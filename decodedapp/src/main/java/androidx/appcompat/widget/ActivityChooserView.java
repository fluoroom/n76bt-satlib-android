...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModel.ActivityChooserModelClient {
    ...
    private class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        public View getView(int i10, View view, ViewGroup viewGroup) {
            ...
            if (itemViewType != 0) {
                ...
                View viewInflate = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(h.g.f14871f, viewGroup, false);
                viewInflate.setId(1);
                ((TextView) viewInflate.findViewById(h.f.S)).setText(ActivityChooserView.this.getContext().getString(h.h.f14889b));
                return viewInflate;
            }
            if (view == null || view.getId() != h.f.f14863x) {
                view = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(h.g.f14871f, viewGroup, false);
            }
            PackageManager packageManager = ActivityChooserView.this.getContext().getPackageManager();
            ImageView imageView = (ImageView) view.findViewById(h.f.f14861v);
        ...
        public void setShowDefaultActivity(boolean z10, boolean z11) {
            if (this.mShowDefaultActivity == z10 && this.mHighlightDefaultActivity == z11) {
                return;
            }
            this.mShowDefaultActivity = z10;
            this.mHighlightDefaultActivity = z11;
            notifyDataSetChanged();
        }

        public void setShowFooterView(boolean z10) {
            if (this.mShowFooterView != z10) {
                this.mShowFooterView = z10;
                notifyDataSetChanged();
            }
        }
    }
    ...
    private class Callbacks implements AdapterView.OnItemClickListener, View.OnClickListener, View.OnLongClickListener, PopupWindow.OnDismissListener {
        ...
        public void onDismiss() {
            ...
            m0.b bVar = ActivityChooserView.this.mProvider;
            if (bVar != null) {
    ...
    void showPopupUnchecked(int i10) {
        ...
        m0.b bVar = this.mProvider;
        if (bVar != null) {
            bVar.subUiVisibilityChanged(true);
        }
        listPopupWindow.getListView().setContentDescription(getContext().getString(h.h.f14890c));
    ...
    public ActivityChooserView(Context context, AttributeSet attributeSet, int i10) {
        ...
        this.mInitialActivityCount = typedArrayObtainStyledAttributes.getInt(h.j.G, 4);
        Drawable drawable = typedArrayObtainStyledAttributes.getDrawable(h.j.F);
        typedArrayObtainStyledAttributes.recycle();
        LayoutInflater.from(getContext()).inflate(h.g.f14870e, (ViewGroup) this, true);
        Callbacks callbacks = new Callbacks();
        this.mCallbacks = callbacks;
        View viewFindViewById = findViewById(h.f.f14849j);
        this.mActivityChooserContent = viewFindViewById;
        this.mActivityChooserContentBackground = viewFindViewById.getBackground();
        android.widget.FrameLayout frameLayout = (android.widget.FrameLayout) findViewById(h.f.f14857r);
        ...
        android.widget.FrameLayout frameLayout2 = (android.widget.FrameLayout) findViewById(h.f.f14859t);
        ...
        frameLayout2.setAccessibilityDelegate(new View.AccessibilityDelegate() { // from class: androidx.appcompat.widget.ActivityChooserView.3
            ...
            public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfo accessibilityNodeInfo) {
                ...
                x.Y0(accessibilityNodeInfo).q0(true);
            }
        });
        ...
        this.mListPopupMaxWidth = Math.max(resources.getDisplayMetrics().widthPixels / 2, resources.getDimensionPixelSize(h.d.f14802d));
    }
}
