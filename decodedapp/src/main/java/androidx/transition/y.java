...
abstract class y {
    ...
    static {
        f3465a = Build.VERSION.SDK_INT >= 28;
    }
    ...
    static View a(ViewGroup viewGroup, View view, View view2) {
        ...
        imageView.measure(View.MeasureSpec.makeMeasureSpec(iRound3 - iRound, WXVideoFileObject.FILE_SIZE_LIMIT), View.MeasureSpec.makeMeasureSpec(iRound4 - iRound2, WXVideoFileObject.FILE_SIZE_LIMIT));
