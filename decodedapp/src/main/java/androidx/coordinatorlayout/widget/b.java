...
public abstract class b {
    ...
    private static final ThreadLocal f1896a = new ThreadLocal();

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static final ThreadLocal f1897b = new ThreadLocal();
    ...
    static void c(ViewGroup viewGroup, View view, Rect rect) {
        ThreadLocal threadLocal = f1896a;
        ...
        ThreadLocal threadLocal2 = f1897b;
