...
abstract class g {
    ...
    static final byte[] f2814a = {112, 114, 111, 0};

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    static final byte[] f2815b = {112, 114, 109, 0};

    private static void A(byte[] bArr, int i10, int i11, c cVar) {
        int iM = m(i10, i11, cVar.f2802g);
        int i12 = iM / 8;
    ...
    static boolean C(OutputStream outputStream, byte[] bArr, c[] cVarArr) throws IOException {
        if (Arrays.equals(bArr, i.f2827a)) {
            P(outputStream, cVarArr);
            return true;
        }
        if (Arrays.equals(bArr, i.f2828b)) {
            O(outputStream, cVarArr);
            return true;
        }
        if (Arrays.equals(bArr, i.f2830d)) {
            M(outputStream, cVarArr);
            return true;
        }
        if (Arrays.equals(bArr, i.f2829c)) {
            N(outputStream, cVarArr);
            return true;
        }
        if (!Arrays.equals(bArr, i.f2831e)) {
            return false;
        }
    ...
    private static j E(c[] cVarArr) throws IOException {
        ...
        try {
            ...
            int i10 = 2;
            for (c cVar : cVarArr) {
                d.q(byteArrayOutputStream, cVar.f2798c);
                d.q(byteArrayOutputStream, cVar.f2799d);
                d.q(byteArrayOutputStream, cVar.f2802g);
                String strJ = j(cVar.f2796a, cVar.f2797b, i.f2827a);
                int iK = d.k(strJ);
    ...
    private static void H(OutputStream outputStream, c cVar, String str) throws IOException {
        ...
        d.p(outputStream, cVar.f2800e);
        d.q(outputStream, cVar.f2801f);
        d.q(outputStream, cVar.f2798c);
        d.q(outputStream, cVar.f2802g);
        d.n(outputStream, str);
    }

    private static void I(OutputStream outputStream, c cVar) throws IOException {
        byte[] bArr = new byte[k(cVar.f2802g)];
        for (Map.Entry entry : cVar.f2804i.entrySet()) {
    ...
    private static void J(OutputStream outputStream, int i10, c cVar) throws IOException {
        byte[] bArr = new byte[l(i10, cVar.f2802g)];
        for (Map.Entry entry : cVar.f2804i.entrySet()) {
            int iIntValue = ((Integer) entry.getKey()).intValue();
            int iIntValue2 = ((Integer) entry.getValue()).intValue();
            int i11 = 0;
            for (int i12 = 1; i12 <= 4; i12 <<= 1) {
                if (i12 != 1 && (i12 & i10) != 0) {
                    if ((i12 & iIntValue2) == i12) {
                        int i13 = (cVar.f2802g * i11) + iIntValue;
                        int i14 = i13 / 8;
    ...
    private static void L(OutputStream outputStream, c[] cVarArr) throws IOException {
        ...
        for (c cVar : cVarArr) {
            String strJ = j(cVar.f2796a, cVar.f2797b, i.f2831e);
            d.p(outputStream, d.k(strJ));
            d.p(outputStream, cVar.f2804i.size());
            d.p(outputStream, cVar.f2803h.length);
            d.q(outputStream, cVar.f2798c);
            d.n(outputStream, strJ);
            Iterator it = cVar.f2804i.keySet().iterator();
            while (it.hasNext()) {
                d.p(outputStream, ((Integer) it.next()).intValue());
            }
            for (int i10 : cVar.f2803h) {
    ...
    private static void M(OutputStream outputStream, c[] cVarArr) throws IOException {
        ...
        for (c cVar : cVarArr) {
            int size = cVar.f2804i.size() * 4;
            String strJ = j(cVar.f2796a, cVar.f2797b, i.f2830d);
            d.p(outputStream, d.k(strJ));
            d.p(outputStream, cVar.f2803h.length);
    ...
    private static void Q(OutputStream outputStream, c[] cVarArr) throws IOException {
        ...
        long length2 = ((long) i.f2827a.length) + ((long) f2814a.length) + 4 + ((long) (arrayList.size() * 16));
        d.q(outputStream, arrayList.size());
        for (int i10 = 0; i10 < arrayList.size(); i10++) {
            j jVar = (j) arrayList.get(i10);
            d.q(outputStream, jVar.f2834a.d());
            d.q(outputStream, length2);
            if (jVar.f2837d) {
                byte[] bArr = jVar.f2836c;
                ...
                arrayList2.add(jVar.f2836c);
                d.q(outputStream, jVar.f2836c.length);
                d.q(outputStream, 0L);
                length = jVar.f2836c.length;
            }
            length2 += (long) length;
        }
    ...
    private static int a(c cVar) {
        Iterator it = cVar.f2804i.entrySet().iterator();
        int iIntValue = 0;
        while (it.hasNext()) {
    ...
    private static byte[] b(c[] cVarArr, byte[] bArr) throws IOException {
        ...
        int iK = 0;
        for (c cVar : cVarArr) {
            iK += d.k(j(cVar.f2796a, cVar.f2797b, bArr)) + 16 + (cVar.f2800e * 2) + cVar.f2801f + k(cVar.f2802g);
        }
        ...
        if (Arrays.equals(bArr, i.f2829c)) {
            ...
            while (i10 < length) {
                c cVar2 = cVarArr[i10];
                H(byteArrayOutputStream, cVar2, j(cVar2.f2796a, cVar2.f2797b, bArr));
                G(byteArrayOutputStream, cVar2);
                i10++;
            }
        } else {
            for (c cVar3 : cVarArr) {
                H(byteArrayOutputStream, cVar3, j(cVar3.f2796a, cVar3.f2797b, bArr));
            }
    ...
    private static j c(c[] cVarArr) throws IOException {
        ...
        for (int i11 = 0; i11 < cVarArr.length; i11++) {
            try {
                ...
                d.p(byteArrayOutputStream, cVar.f2800e);
                i10 = i10 + 4 + (cVar.f2800e * 2);
    ...
    private static c i(c[] cVarArr, String str) {
        ...
        for (int i10 = 0; i10 < cVarArr.length; i10++) {
            if (cVarArr[i10].f2797b.equals(strH)) {
                return cVarArr[i10];
            }
        }
        return null;
    ...
    static byte[] p(InputStream inputStream, byte[] bArr) {
        if (Arrays.equals(bArr, d.d(inputStream, bArr.length))) {
            return d.d(inputStream, i.f2828b.length);
        }
        throw d.c("Invalid magic");
    }

    private static void q(InputStream inputStream, c cVar) {
        int iAvailable = inputStream.available() - cVar.f2801f;
        int iH = 0;
        while (inputStream.available() > iAvailable) {
            iH += d.h(inputStream);
            cVar.f2804i.put(Integer.valueOf(iH), 1);
    ...
    static c[] r(InputStream inputStream, byte[] bArr, byte[] bArr2, c[] cVarArr) {
        if (Arrays.equals(bArr, i.f2832f)) {
            if (Arrays.equals(i.f2827a, bArr2)) {
        ...
        if (Arrays.equals(bArr, i.f2833g)) {
    ...
    private static void w(InputStream inputStream, c cVar) {
        BitSet bitSetValueOf = BitSet.valueOf(d.d(inputStream, d.a(cVar.f2802g * 2)));
        int i10 = 0;
        while (true) {
            int i11 = cVar.f2802g;
            if (i10 >= i11) {
            ...
            if (iO != 0) {
                Integer num = (Integer) cVar.f2804i.get(Integer.valueOf(i10));
                if (num == null) {
                    num = 0;
                }
                cVar.f2804i.put(Integer.valueOf(i10), Integer.valueOf(iO | num.intValue()));
            }
            i10++;
        }
    }
    ...
    private static c[] y(InputStream inputStream, String str, int i10) {
        ...
        for (int i11 = 0; i11 < i10; i11++) {
            ...
            long jI = d.i(inputStream);
            cVarArr[i11] = new c(str, d.f(inputStream, iH), d.i(inputStream), 0L, iH2, (int) jI, (int) d.i(inputStream), new int[iH2], new TreeMap());
        }
        for (int i12 = 0; i12 < i10; i12++) {
            c cVar = cVarArr[i12];
            q(inputStream, cVar);
            cVar.f2803h = n(inputStream, cVar.f2800e);
            w(inputStream, cVar);
        }
        return cVarArr;
    }
