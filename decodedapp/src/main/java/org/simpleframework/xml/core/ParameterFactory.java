...
class ParameterFactory {
    ...
    public Parameter getInstance(Constructor constructor, Annotation annotation, int i10) throws Exception {
        return getInstance(constructor, annotation, null, i10);
    }

    public Parameter getInstance(Constructor constructor, Annotation annotation, Annotation annotation2, int i10) throws Exception {
