...
class SignatureScanner {
    ...
    private List<Parameter> create(Annotation annotation, int i10) throws Exception {
    ...
    private List<Parameter> union(Annotation annotation, int i10) throws Exception {
    ...
    private void scan(Class cls, int i10) throws Exception {
