...
class ElementListUnionParameter extends TemplateParameter {
    ...
    public ElementListUnionParameter(Constructor constructor, ElementListUnion elementListUnion, ElementList elementList, Format format, int i10) throws Exception {
