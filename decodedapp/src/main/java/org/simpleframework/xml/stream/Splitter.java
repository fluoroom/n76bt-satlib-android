...
abstract class Splitter {
    ...
    protected abstract void commit(char[] cArr, int i10, int i11);

    protected abstract void parse(char[] cArr, int i10, int i11);
    ...
    protected char toLower(char c10) {
        return Character.toLowerCase(c10);
    }

    protected char toUpper(char c10) {
