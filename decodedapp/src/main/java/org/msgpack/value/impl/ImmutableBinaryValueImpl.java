...
public class ImmutableBinaryValueImpl extends AbstractImmutableRawValue implements ImmutableBinaryValue {
    ...
    public boolean equals(Object obj) {
        ...
        if (value.isBinaryValue()) {
            return value instanceof ImmutableBinaryValueImpl ? Arrays.equals(this.data, ((ImmutableBinaryValueImpl) value).data) : Arrays.equals(this.data, value.asBinaryValue().asByteArray());
        }
        return false;
    }
