...
public abstract class b {
    ...
    private InterfaceC0281b mVisibilityListener;
    ...
    public void setVisibilityListener(InterfaceC0281b interfaceC0281b) {
        if (this.mVisibilityListener != null && interfaceC0281b != null) {
            Log.w(TAG, "setVisibilityListener: Setting a new ActionProvider.VisibilityListener when one is already set. Are you reusing this " + getClass().getSimpleName() + " instance while it is still in use somewhere else?");
        }
        this.mVisibilityListener = interfaceC0281b;
    }
