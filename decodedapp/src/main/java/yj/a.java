...
public class a extends gj.a implements n0 {

    /* JADX INFO: renamed from: yj.a$a, reason: collision with other inner class name */
    public static class C0441a implements n0.a {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private final Pattern f32646a;
        ...
        public C0441a() {
            ...
            sb2.append(")");
            this.f32646a = Pattern.compile("^\\p{Blank}*\\p{Blank}*([-+]?\\p{Digit}+)" + sb2.toString() + "\\p{Blank}*([-+]?\\p{Digit}+)\\p{Blank}*\\p{Blank}*([-+]?(?:\\p{Digit}+(?:\\.\\p{Digit}*)?|\\.\\p{Digit}+)(?:[eE][-+]?\\p{Digit}+)?)\\p{Blank}*\\p{Blank}*([-+]?(?:\\p{Digit}+(?:\\.\\p{Digit}*)?|\\.\\p{Digit}+)(?:[eE][-+]?\\p{Digit}+)?)\\p{Blank}*\\p{Blank}*([-+]?(?:\\p{Digit}+(?:\\.\\p{Digit}*)?|\\.\\p{Digit}+)(?:[eE][-+]?\\p{Digit}+)?)\\p{Blank}*\\p{Blank}*([-+]?(?:\\p{Digit}+(?:\\.\\p{Digit}*)?|\\.\\p{Digit}+)(?:[eE][-+]?\\p{Digit}+)?)\\p{Blank}*$");
        }
            ...
            try {
                ...
                try {
                    ...
                    while (line != null) {
                        i10++;
                        try {
                            Matcher matcher = this.f32646a.matcher(line);
                            if (matcher.matches()) {
    ...
    public a(String str, gj.g gVar) {
        super(str, gVar);
    }

    @Override // yj.n0
    public List c() {
        o0 o0Var = new o0(new C0441a());
        d(o0Var);
        return o0Var.b();
    }
}
