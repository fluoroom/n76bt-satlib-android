...
public abstract class g {
    ...
    public static pi.b c(pi.b bVar, pi.b bVar2, pi.b bVar3) {
        ...
        return (pi.b) ((pi.b) bVar3.O((pi.b) bVar.N((pi.b) fVarQ.b()))).H((pi.b) bVar2.N((pi.b) fVarQ.a()));
    }
    ...
    public static pi.b e(pi.b bVar, pi.b bVar2, pi.b bVar3) {
        ...
        while (true) {
            ...
            pi.b bVar8 = (pi.b) ((pi.b) ((pi.b) ((pi.b) bVar.N((pi.b) fVarQ.a())).H((pi.b) bVar2.N((pi.b) fVarQ.b()))).negate()).add(1.0d);
            pi.b bVar9 = (pi.b) bVar5.O(bVar7);
            pi.b bVar10 = (pi.b) bVar8.K(2.0d);
        ...
        throw new hj.a(hj.f.UNABLE_TO_COMPUTE_ECCENTRIC_LONGITUDE_ARGUMENT, Integer.valueOf(i10));
    }
    ...
    public static pi.b g(pi.b bVar, pi.b bVar2, pi.b bVar3) {
        ...
        pi.b bVar4 = (pi.b) fVarQ.a();
        pi.b bVar5 = (pi.b) fVarQ.b();
        return (pi.b) bVar3.H(a((pi.b) ((pi.b) bVar2.N(bVar4)).O((pi.b) bVar.N(bVar5)), (pi.b) ((pi.b) ((pi.b) bVarB.add(1.0d)).H((pi.b) bVar.N(bVar4))).H((pi.b) bVar2.N(bVar5))));
    }
