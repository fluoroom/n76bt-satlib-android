...
abstract class e0 {
    ...
    static final Type[] f11136a = new Type[0];

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static boolean f11137b = true;

    private static final class a implements GenericArrayType {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private final Type f11138a;
        ...
        public boolean equals(Object obj) {
            return (obj instanceof GenericArrayType) && e0.d(this, (GenericArrayType) obj);
        }
    ...
    static final class b implements ParameterizedType {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private final Type f11139a;

        /* JADX INFO: renamed from: b, reason: collision with root package name */
        private final Type f11140b;

        /* JADX INFO: renamed from: c, reason: collision with root package name */
        private final Type[] f11141c;
        ...
        b(Type type, Type type2, Type... typeArr) {
            ...
            this.f11139a = type;
            this.f11140b = type2;
            this.f11141c = (Type[]) typeArr.clone();
        }

        public boolean equals(Object obj) {
            return (obj instanceof ParameterizedType) && e0.d(this, (ParameterizedType) obj);
        }

        @Override // java.lang.reflect.ParameterizedType
        public Type[] getActualTypeArguments() {
            return (Type[]) this.f11141c.clone();
        }
        ...
        public int hashCode() {
            int iHashCode = Arrays.hashCode(this.f11141c) ^ this.f11140b.hashCode();
            Type type = this.f11139a;
            return iHashCode ^ (type != null ? type.hashCode() : 0);
        }

        public String toString() {
            Type[] typeArr = this.f11141c;
            if (typeArr.length == 0) {
                return e0.u(this.f11140b);
            }
            StringBuilder sb2 = new StringBuilder((typeArr.length + 1) * 30);
            sb2.append(e0.u(this.f11140b));
            sb2.append("<");
            sb2.append(e0.u(this.f11141c[0]));
            for (int i10 = 1; i10 < this.f11141c.length; i10++) {
                sb2.append(", ");
                sb2.append(e0.u(this.f11141c[i10]));
            }
            sb2.append(">");
            return sb2.toString();
        }
    ...
    private static final class c implements WildcardType {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private final Type f11142a;

        /* JADX INFO: renamed from: b, reason: collision with root package name */
        private final Type f11143b;
        ...
        c(Type[] typeArr, Type[] typeArr2) {
            ...
            this.f11143b = typeArr2[0];
            this.f11142a = Object.class;
        }

        public boolean equals(Object obj) {
            return (obj instanceof WildcardType) && e0.d(this, (WildcardType) obj);
        }

        @Override // java.lang.reflect.WildcardType
        public Type[] getLowerBounds() {
            Type type = this.f11143b;
            return type != null ? new Type[]{type} : e0.f11136a;
        }

        @Override // java.lang.reflect.WildcardType
        public Type[] getUpperBounds() {
            return new Type[]{this.f11142a};
        }

        public int hashCode() {
            Type type = this.f11143b;
            return (type != null ? type.hashCode() + 31 : 1) ^ (this.f11142a.hashCode() + 31);
        }

        public String toString() {
            if (this.f11143b != null) {
                return "? super " + e0.u(this.f11143b);
            }
            if (this.f11142a == Object.class) {
                return "?";
            }
            return "? extends " + e0.u(this.f11142a);
        }
    }
    ...
    static i0 a(i0 i0Var) {
        vh.e eVar = new vh.e();
        i0Var.source().B(eVar);
        return i0.create(i0Var.contentType(), i0Var.contentLength(), eVar);
    }
    ...
    static boolean m(Type type) {
        return f11137b && type == dd.d0.class;
    }
    ...
    static RuntimeException p(Method method, int i10, String str, Object... objArr) {
        return n(method, str + " (" + v.f11258b.a(method, i10) + ")", objArr);
    }

    static RuntimeException q(Method method, Throwable th2, int i10, String str, Object... objArr) {
        return o(method, th2, str + " (" + v.f11258b.a(method, i10) + ")", objArr);
    }
            ...
            if (lowerBounds.length == 1) {
                ...
                if (upperBounds.length == 1) {
                    ...
                    if (typeR6 != upperBounds[0]) {
                        return new c(new Type[]{typeR6}, f11136a);
                    }
                }
            }
        }
