...
public abstract class a {
    ...
    private static final Set f15051a = new HashSet();

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static final boolean f15052b = n(System.getProperty("java.vm.version"));
    ...
    private static void m(ClassLoader classLoader, File file, List list) throws IllegalAccessException, NoSuchFieldException, IOException {
        ...
        C0209a.a(classLoader, list, file);
    }
