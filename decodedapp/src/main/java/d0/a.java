...
public abstract class a {
    ...
    private static final ThreadLocal f10508a = new ThreadLocal();
    ...
    public static int b(double d10, double d11, double d12) {
        ...
        return Color.rgb(i((int) Math.round((d13 > 0.0031308d ? (Math.pow(d13, 0.4166666666666667d) * 1.055d) - 0.055d : d13 * 12.92d) * 255.0d), 0, 255), i((int) Math.round((d14 > 0.0031308d ? (Math.pow(d14, 0.4166666666666667d) * 1.055d) - 0.055d : d14 * 12.92d) * 255.0d), 0, 255), i((int) Math.round((d15 > 0.0031308d ? (Math.pow(d15, 0.4166666666666667d) * 1.055d) - 0.055d : 12.92d * d15) * 255.0d), 0, 255));
    }
    ...
    private static double[] j() {
        ThreadLocal threadLocal = f10508a;
