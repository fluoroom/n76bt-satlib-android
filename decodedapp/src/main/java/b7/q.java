...
public class q {
    ...
    protected static final Set f3716b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static final q f3717c;

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    protected Set f3718a = f3716b;
    ...
    static {
        ...
        f3716b = DesugarCollections.unmodifiableSet(hashSet);
        f3717c = new q();
    }
    ...
    public void b(p6.h hVar, JavaType javaType, p6.c cVar) {
        Class clsR = javaType.r();
        String name = clsR.getName();
        if (!this.f3718a.contains(name)) {
            if (clsR.isInterface()) {
                return;
            }
            if (name.startsWith("org.springframework.")) {
                while (clsR != null && clsR != Object.class) {
                    String simpleName = clsR.getSimpleName();
                    if (!"AbstractPointcutAdvisor".equals(simpleName) && !"AbstractApplicationContext".equals(simpleName)) {
                        clsR = clsR.getSuperclass();
                    }
                }
                return;
            }
        ...
        hVar.O0(cVar, "Illegal type (%s) to deserialize: prevented for security reasons", name);
    }
}
