...
public abstract class m {
    ...
    private static final int[] f8031a = {h.a.M};

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static final int[] f8032b = {u8.b.f28551g};

    public static void a(Context context) {
        e(context, f8031a, "Theme.AppCompat");
    }

    private static void b(Context context, AttributeSet attributeSet, int i10, int i11) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, u8.l.W7, i10, i11);
        boolean z10 = typedArrayObtainStyledAttributes.getBoolean(u8.l.Y7, false);
        typedArrayObtainStyledAttributes.recycle();
        if (z10) {
            TypedValue typedValue = new TypedValue();
            if (!context.getTheme().resolveAttribute(u8.b.f28559o, typedValue, true) || (typedValue.type == 18 && typedValue.data == 0)) {
                c(context);
            }
        }
        a(context);
    ...
    public static void c(Context context) {
        e(context, f8032b, "Theme.MaterialComponents");
    }

    private static void d(Context context, AttributeSet attributeSet, int[] iArr, int i10, int i11, int... iArr2) {
        boolean zF;
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, u8.l.W7, i10, i11);
        if (!typedArrayObtainStyledAttributes.getBoolean(u8.l.Z7, false)) {
            typedArrayObtainStyledAttributes.recycle();
            return;
        }
        if (iArr2 == null || iArr2.length == 0) {
            zF = typedArrayObtainStyledAttributes.getResourceId(u8.l.X7, -1) != -1;
        } else {
    ...
    public static boolean g(Context context) {
        return j9.b.b(context, u8.b.f28558n, false);
    }
    ...
    public static TintTypedArray j(Context context, AttributeSet attributeSet, int[] iArr, int i10, int i11, int... iArr2) {
        b(context, attributeSet, i10, i11);
        d(context, attributeSet, iArr, i10, i11, iArr2);
