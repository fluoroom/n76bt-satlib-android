...
abstract class g {
    ...
    private static final int[] f7404a = {R.attr.stateListAnimator};
    ...
    static void b(View view, float f10) {
        int integer = view.getResources().getInteger(u8.g.f28669a);
        StateListAnimator stateListAnimator = new StateListAnimator();
        long j10 = integer;
        stateListAnimator.addState(new int[]{R.attr.state_enabled, u8.b.V, -u8.b.W}, ObjectAnimator.ofFloat(view, "elevation", 0.0f).setDuration(j10));
    ...
    static void c(View view, AttributeSet attributeSet, int i10, int i11) {
        ...
        TypedArray typedArrayI = m.i(context, attributeSet, f7404a, i10, i11, new int[0]);
        try {
