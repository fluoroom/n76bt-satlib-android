...
public abstract class b {
    ...
    private static final ThreadLocal f7995a = new ThreadLocal();

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static final ThreadLocal f7996b = new ThreadLocal();
    ...
    public static void c(ViewGroup viewGroup, View view, Rect rect) {
        ThreadLocal threadLocal = f7995a;
        ...
        ThreadLocal threadLocal2 = f7996b;
