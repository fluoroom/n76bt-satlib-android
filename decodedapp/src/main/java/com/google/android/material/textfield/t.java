...
abstract class t {
    ...
    static void e(CheckableImageButton checkableImageButton) {
        if (Build.VERSION.SDK_INT < 23) {
            checkableImageButton.setBackground(k9.a.b(checkableImageButton.getContext(), (int) com.google.android.material.internal.p.c(checkableImageButton.getContext(), 4)));
        }
    }
