...
public class LightHttpServer {
    ...
    public void serve(SocketLike socketLike) throws IOException {
        LeakyBufferedInputStream leakyBufferedInputStream = new LeakyBufferedInputStream(socketLike.getInput(), WXMediaMessage.DESCRIPTION_LENGTH_LIMIT);
