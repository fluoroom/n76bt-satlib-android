        ...
        if (storageId.isLocalStorage) {
            ...
            try {
                if (obj != null) {
                    ...
                    try {
                        assignByType(editorEdit, string, SharedPreferencesHelper.valueFromString(string2, obj));
                        editorEdit.apply();
                        return;
            ...
            } catch (DOMStorageAssignmentException e10) {
                CLog.writeToConsole(this.mDOMStoragePeerManager, Console.MessageLevel.ERROR, Console.MessageSource.STORAGE, e10.getMessage());
