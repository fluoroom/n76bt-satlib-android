...
public class DOM implements ChromeDevtoolsDomain {
    ...
    private final Map<String, List<Integer>> mSearchResults = DesugarCollections.synchronizedMap(new HashMap());
    ...
    private final class DocumentUpdateListener implements Document.UpdateListener {
        ...
        public void onChildNodeInserted(DocumentView documentView, Object obj, int i10, int i11, Accumulator<Object> accumulator) {
            ...
            childNodeInsertedEventAcquireChildNodeInsertedEvent.parentNodeId = i10;
            childNodeInsertedEventAcquireChildNodeInsertedEvent.previousNodeId = i11;
        ...
        public void onChildNodeRemoved(int i10, int i11) {
            ...
            childNodeRemovedEventAcquireChildNodeRemovedEvent.parentNodeId = i10;
            childNodeRemovedEventAcquireChildNodeRemovedEvent.nodeId = i11;
    ...
    private static class RGBAColor {
        ...
        public int getColor() {
            Double d10 = this.f7071a;
            byte b10 = -1;
            if (d10 != null) {
                long jRound = Math.round(d10.doubleValue() * 255.0d);
                if (jRound < 0) {
                    b10 = 0;
                } else if (jRound < 255) {
                    b10 = (byte) jRound;
            ...
            return Color.argb((int) b10, this.f7074r, this.f7073g, this.f7072b);
        }
    }
    ...
    public Node createNodeForElement(Object obj, DocumentView documentView, Accumulator<Object> accumulator) {
        ...
        List<Node> arrayList = elementInfo.children.size() == 0 ? Collections.EMPTY_LIST : new ArrayList<>(elementInfo.children.size());
        int size = elementInfo.children.size();
        for (int i10 = 0; i10 < size; i10++) {
            arrayList.add(createNodeForElement(elementInfo.children.get(i10), documentView, accumulator));
        }
