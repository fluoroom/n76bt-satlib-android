...
final class ViewGroupDescriptor extends AbstractChainedDescriptor<ViewGroup> implements HighlightableDescriptor<ViewGroup> {
    private final Map<View, Object> mViewToElementMap = DesugarCollections.synchronizedMap(new WeakHashMap());
    ...
    @Override // com.facebook.stetho.inspector.elements.android.HighlightableDescriptor
    public Object getElementToHighlightAtPosition(ViewGroup viewGroup, int i10, int i11, Rect rect) {
        View childAt;
