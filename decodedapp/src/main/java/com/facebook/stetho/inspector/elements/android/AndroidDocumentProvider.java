...
final class AndroidDocumentProvider extends ThreadBoundProxy implements DocumentProvider, AndroidDescriptorHost {
            ...
            AndroidDocumentProvider.this.getWindows(new Accumulator<Window>() { // from class: com.facebook.stetho.inspector.elements.android.AndroidDocumentProvider.InspectModeHandler.2
                ...
                public void store(Window window) {
                    if (window.peekDecorView() instanceof ViewGroup) {
                        ...
                        OverlayView overlayView = inspectModeHandler.new OverlayView(AndroidDocumentProvider.this.mApplication);
    ...
    public HighlightableDescriptor getHighlightableDescriptor(Object obj) {
        ...
        Object obj2 = null;
        while (highlightableDescriptor == null && superclass != null) {
            Object obj3 = this.mDescriptorMap.get(superclass);
            if (obj3 == null) {
                return null;
            }
            if (obj3 != obj2 && (obj3 instanceof HighlightableDescriptor)) {
                highlightableDescriptor = (HighlightableDescriptor) obj3;
            }
