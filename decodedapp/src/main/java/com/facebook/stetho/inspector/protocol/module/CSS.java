...
public class CSS implements ChromeDevtoolsDomain {
    ...
    public JsonRpcResult getMatchedStylesForNode(JsonRpcPeer jsonRpcPeer, JSONObject jSONObject) {
        ...
        getMatchedStylesForNodeResult.inherited = list;
        getMatchedStylesForNodeResult.pseudoElements = list;
                ...
                if (elementForNodeId != null) {
                    CSS.this.mDocument.getElementStyleRuleNames(elementForNodeId, new StyleRuleNameAccumulator() { // from class: com.facebook.stetho.inspector.protocol.module.CSS.2.1
                        ...
                        public void store(String str, boolean z10) {
                            ...
                            cSSStyle.shorthandEntries = Collections.EMPTY_LIST;
                            if (z10) {
                                cSSStyle.styleSheetId = String.format("%s.%s", Integer.toString(getMatchedStylesForNodeRequest.nodeId), selector.value);
                            }
                            CSS.this.mDocument.getElementStyles(elementForNodeId, str, new StyleAccumulator() { // from class: com.facebook.stetho.inspector.protocol.module.CSS.2.1.1
                                ...
                                public void store(String str2, String str3, boolean z11) {
    ...
    public SetPropertyTextResult setPropertyText(JsonRpcPeer jsonRpcPeer, JSONObject jSONObject) {
        ...
        final int i10 = Integer.parseInt(strArrSplit[0]);
        final String str2 = strArrSplit[1];
        String str3 = setPropertyTextRequest.text;
        if (str3 == null || !str3.contains(":")) {
            str = null;
            strTrim = null;
        } else {
            String[] strArrSplit2 = setPropertyTextRequest.text.split(":", 2);
        ...
        setPropertyTextResult.style.shorthandEntries = Collections.EMPTY_LIST;
        this.mDocument.postAndWait(new Runnable() { // from class: com.facebook.stetho.inspector.protocol.module.CSS.3
            @Override // java.lang.Runnable
            public void run() {
                Object elementForNodeId = CSS.this.mDocument.getElementForNodeId(i10);
                if (elementForNodeId != null) {
                    if (str != null) {
                    ...
                    CSS.this.mDocument.getElementStyles(elementForNodeId, str2, new StyleAccumulator() { // from class: com.facebook.stetho.inspector.protocol.module.CSS.3.1
                        @Override // com.facebook.stetho.inspector.elements.StyleAccumulator
                        public void store(String str4, String str5, boolean z10) {
                            CSSProperty cSSProperty = new CSSProperty();
                    ...
                    LogUtil.w("Failed to get style of an element that does not exist, nodeid=" + i10);
                }
            }
        });
