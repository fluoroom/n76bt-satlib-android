...
public class Stetho {
    ...
    public static final class DefaultInspectorModulesBuilder {
        ...
        private DocumentProviderFactory resolveDocumentProvider() {
            ...
            return documentProviderFactory != null ? documentProviderFactory : new AndroidDocumentProviderFactory(this.mContext, Collections.EMPTY_LIST);
        }
        ...
        public Iterable<ChromeDevtoolsDomain> finish() {
            ...
            DocumentProviderFactory documentProviderFactoryResolveDocumentProvider = resolveDocumentProvider();
            if (documentProviderFactoryResolveDocumentProvider != null) {
                Document document = new Document(documentProviderFactoryResolveDocumentProvider);
            ...
            RuntimeReplFactory rhinoDetectingRuntimeReplFactory = this.mRuntimeRepl;
            if (rhinoDetectingRuntimeReplFactory == null) {
            ...
            if (!z10 && !this.mExcludeSqliteDatabaseDriver) {
                ...
                DatabaseFilesProvider defaultDatabaseFilesProvider = this.mDatabaseFilesProvider;
                if (defaultDatabaseFilesProvider == null) {
                    defaultDatabaseFilesProvider = new DefaultDatabaseFilesProvider(application);
                }
                database.add(new SqliteDatabaseDriver(application, defaultDatabaseFilesProvider, new DefaultDatabaseConnectionProvider()));
            }
