...
public final class TopLayout extends FrameLayout {
    ...
    public /* synthetic */ TopLayout(Context context, AttributeSet attributeSet, int i10, int i11, h hVar) {
