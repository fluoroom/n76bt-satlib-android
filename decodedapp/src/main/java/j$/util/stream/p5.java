...
public final class p5 extends y0 {
    ...
    public final /* synthetic */ long f18122s;

    /* JADX INFO: renamed from: t, reason: collision with root package name */
    public final /* synthetic */ long f18123t;
    ...
    public final Spliterator O0(a aVar, Spliterator spliterator) {
        ...
        if (jK0 > 0 && spliterator.hasCharacteristics(16384)) {
            ...
            long j10 = this.f18122s;
            return new p7(x0Var, j10, v3.Z(j10, this.f18123t));
        }
        if (y6.ORDERED.l(aVar.f17893m)) {
            return ((g2) new v5(this, aVar, spliterator, new b1(16), this.f18122s, this.f18123t).invoke()).spliterator();
        }
        j$.util.x0 x0Var2 = (j$.util.x0) aVar.H0(spliterator);
        long j11 = this.f18122s;
        long j12 = this.f18123t;
        if (j11 <= jK0) {
            long jMin = jK0 - j11;
            if (j12 >= 0) {
    ...
    public final g2 N0(v3 v3Var, Spliterator spliterator, IntFunction intFunction) {
        ...
        if (jK0 > 0 && spliterator.hasCharacteristics(16384)) {
            ...
            return v3.c0(v3Var, v3.X(aVar.M0(), spliterator, this.f18122s, this.f18123t), true);
        }
        if (!y6.ORDERED.l(((a) v3Var).f17893m)) {
            j$.util.x0 x0Var = (j$.util.x0) v3Var.H0(spliterator);
            long j11 = this.f18122s;
            long j12 = this.f18123t;
            if (j11 <= jK0) {
                long j13 = jK0 - j11;
            ...
            return v3.c0(this, new v7(x0Var, j10, jMin), true);
        }
        return (g2) new v5(this, v3Var, spliterator, intFunction, this.f18122s, this.f18123t).invoke();
    }
